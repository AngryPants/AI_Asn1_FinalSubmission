...
void SceneText::Init()
{
	...
	MeshBuilder::GetInstance()->GenerateOBJ("OBJ1", "OBJ//chair.obj");
	MeshBuilder::GetInstance()->GetMesh("OBJ1")->textureID = LoadTGA("Image//chair.tga");
	...
	Create::Entity("OBJ1", Vector3(-20.0f, 0.0f, -20.0f));
	Create::Entity("OBJ1", Vector3(20.0f, 0.0f, -20.0f));
	Create::Ground("GRASS_DARKGREEN", "GEO_GRASS_LIGHTGREEN");
